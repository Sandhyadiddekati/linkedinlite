package com.google.linkedinlight.configuration;
...
public class ApplicationConfiguration {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		contact.setName("linkedinlight");
		contact.setUrl("http://localhost:8081");

		License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

		Info info = new Info().title("linkedinlight RESTful Web Service documentation").version("1.0").contact(contact)
